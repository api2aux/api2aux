 ...
 * Defaults to empty — callers must explicitly opt in to enrichment registry categories
 * to keep the coupling visible and avoid surprising behavior in isolation.
 */
